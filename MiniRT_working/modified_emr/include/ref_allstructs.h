...
typedef struct s_camera
{
	...
	t_mat4s		inv_transform; //The inverse transformation matrix of the camera. This matrix is used to transform scene coordinates into camera coordinates.
	...
	t_vec4s		trans; //The translation vector of the camera. This defines the camera's position in the scene.
	...
	float		half_width; //Half the width of the frame.
	...
	float		pixel_size; //The size of a single pixel in scene units. This is used to map screen coordinates to scene coordinates and vice versa.
}	t_camera;
